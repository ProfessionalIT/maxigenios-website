...
def layout():
    ...
    extend_([u'        </fieldset>\n'])
    extend_([u'    </div>\n'])
    extend_([u'    <div id="footer"><p>ProfessionalIT 2015 - Uma empresa do grupo <a href="http://www.maxigenios.com.br" title="MaxiG\xeanios - Genialidade em Solu\xe7\xf5es Tecnol\xf3gicas" target="_blank">MaxiG\xeanios - Genialidade em Solu\xe7\xf5es Tecnol\xf3gicas.</a></p></div>\n'])
    extend_([u'</body>\n'])
    extend_([u'</html>\n'])
